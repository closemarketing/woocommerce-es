...
* Fixed: A customer downloading their own document could substitute the order_id of any other order they own, including pending, processing, cancelled, or refunded ones, even though My Account only shows the download link for completed orders. The owner download path now requires the order to be completed; order managers are unaffected.
