...
define( 'CONECOM_VERSION', '3.1.5-beta.3' );
 ...
 * @return void
 */
function conecom_review_notice() {
...
add_action( 'admin_notices', 'conecom_review_notice' );

// Handle notice dismissal via AJAX
add_action( 'wp_ajax_conecom_dismiss_review_notice', 'conecom_dismiss_review_notice' );
